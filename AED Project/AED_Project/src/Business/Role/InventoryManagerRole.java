...
import userinterface.InventoryManagement.InventoryReceivingWorkAreaJPanel;
...
public class InventoryManagerRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business,DonorDirectory donor) {
        return new InventoryReceivingWorkAreaJPanel(userProcessContainer, account, organization, business);
    }
